...
gain = revenue - costs  # Результат работы фирмы
rentabel = float(gain) / revenue  # Рентабильность выручки
if gain > 0:
    ...
    print('Результат работы фирмы отрицательный. Её величина: ', gain)
